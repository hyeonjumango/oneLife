...
public class PageInfo {
	...
	private int pageLimit; //한페이지 하단에 보여질 페이징바의 개수
	...
	public PageInfo(int page, int listCount, int pageLimit, int boardLimit) {
		...
		// 글 개수가 105개면 총 페이지수는 나머지 5개까지 한페이지로 생각해서 11페이지가 필요함
		//전체 게시글 수(105) / 한 페이지에 보옂질 게시글 수 (10) 의 결과를 올림 처리
		...
		// *endPage : 현재 페이지에서 보여지는 페이지 방의 마지막 수
