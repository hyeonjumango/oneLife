...
public class mcHistoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (m == null) {
			...
			Map<String, Object> map = new AmentiesService().selectMultilist(page, new Search(mydate, u_no));
			
			request.setAttribute("pi", map.get("pi"));
			request.setAttribute("multiCourtList", map.get("multiCourtList"));
		
		request.getRequestDispatcher("WEB-INF/views/user/jsp/amenities/multiCourtHistory.jsp").forward(request, response);
